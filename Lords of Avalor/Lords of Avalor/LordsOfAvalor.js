...
document.getElementById("millbtn").addEventListener("click", function () {
    ...
    if (resources.lumber >= millCostLumber && resources.gold >= millCostGold) {
        ...
        document.getElementById("millcostlumber").innerHTML = `<img src="C:\\Users\\Gigante\\Desktop\\Projects\\Lords of Avalor\\Images\\Lumber.png" height="35" width="35"/> ${millCostLumber}`;
        document.getElementById("millcostgold").innerHTML = `<img src="C:\\Users\\Gigante\\Desktop\\Projects\\Lords of Avalor\\Images\\Gold.png" height="35" width="35"/> ${millCostGold}`;
